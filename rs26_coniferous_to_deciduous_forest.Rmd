...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs26.bib"
params:
  j: 26
---
...
bs_carousel(id = 'rs26', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/800px-Taiga_Alaska.jpg'), alt = 'Coniferous to deciduous forest'),
    caption = bs_carousel_caption(title = 'Coniferous to deciduous forest'))
...
- Environmental shocks (e.g. fire or floods or droughts) or Global climate change


**Land use**:

- Timber production or Conservation or Tourism
...
- Local/landscape (e.g. lake or catchment or community) or National (country)
...
``` {style='color: gray;'}
@misc{
  author = {Katja Malmborg and Linda Lindström Lindström and Lara D. MateosGarry Peterson and Juan Carlos Rocha},
  title = {Coniferous to deciduous forest},
