...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs5.bib"
params:
  j: 5
---
...
bs_carousel(id = 'rs5', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/3238927961_d33d9b8c90_z.jpg'), alt = 'Arctic sea-ice loss'),
    caption = bs_carousel_caption(title = 'Arctic sea-ice loss'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/800px-Sea_ice_terrain.jpg'), alt = 'Arctic sea-ice loss'),
    caption = bs_carousel_caption(title = 'Arctic sea-ice loss'))
...
``` {style='color: gray;'}
@misc{
  author = {Rolands SadauskisReinette (Oonsie) Biggs and Garry Peterson and Juan Carlos Rocha},
