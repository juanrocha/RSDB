...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs11.bib"
params:
  j: 11
---
...
bs_carousel(id = 'rs11', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/20100225-115633.jpg'), alt = 'Bush encroachment'),
    caption = bs_carousel_caption(title = 'Bush encroachment'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/bushpic.jpg'), alt = 'Bush encroachment'),
    caption = bs_carousel_caption(title = 'Bush encroachment'))
...
- Harvest and resource consumption or Species introduction or removal or Environmental shocks (e.g. fire or floods or droughts)
...
``` {style='color: gray;'}
@misc{
  author = {Bob Scholes and Reinette (Oonsie) Biggs and Juan Carlos Rocha and Linda LuvunoGarry Peterson},
