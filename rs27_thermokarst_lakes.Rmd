...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs27.bib"
params:
  j: 27
---
...
bs_carousel(id = 'rs27', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/Permafrost_thaw_ponds_in_Hudson_Bay_Canada_near_Greenland.jpg'), alt = 'Thermokarst lakes'),
    caption = bs_carousel_caption(title = 'Thermokarst lakes'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/Omulyakhskaya_and_Khromskaya_Bays__Northern_Siberia.jpg'), alt = 'Thermokarst lakes'),
    caption = bs_carousel_caption(title = 'Thermokarst lakes'))
...
``` {style='color: gray;'}
@misc{
  author = {Elinor Holén and Hannah Griffiths and Jessica Spijkers and Hannah Griffiths and Elinor Holén and Jessica SpijkersReinette (Oonsie) Biggs and Juan Carlos Rocha},
  title = {Thermokarst lakes},
