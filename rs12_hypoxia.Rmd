...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs12.bib"
params:
  j: 12
---
...
bs_carousel(id = 'rs12', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/5020120889_a10b03e3e4_o.jpg'), alt = 'Hypoxia'),
    caption = bs_carousel_caption(title = 'Hypoxia'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/4911433052_f535276bdf_b.jpg'), alt = 'Hypoxia'),
    caption = bs_carousel_caption(title = 'Hypoxia'))
...
- Food and nutrition or Health (e.g. toxins or disease) or Livelihoods and economic activity
...
- External inputs (e.g. fertilizers or pest control or irrigation) or Global climate change
...
``` {style='color: gray;'}
@misc{
  author = {Juan Carlos RochaRutger Rosenberg and Reinette (Oonsie) Biggs and Garry Peterson},
  title = {Hypoxia},
