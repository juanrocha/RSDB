...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs25.bib"
params:
  j: 25
---
...
bs_carousel(id = 'rs25', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/6261536855_40fc6782a6_b.jpg'), alt = 'Fisheries collapse'),
    caption = bs_carousel_caption(title = 'Fisheries collapse'))
...
- Harvest and resource consumption or External inputs (e.g. fertilizers or pest control or irrigation) or Adoption of new technology (e.g. new fishing nets) or Species introduction or removal or Disease or Global climate change
...
``` {style='color: gray;'}
@misc{
  author = {Garry Peterson and Juan Carlos RochaHenrik Österblom and Reinette (Oonsie) Biggs},
