...
output: 
  html_document:
    ...
    toc_depth: 3
    toc_float: true
bibliography: "assets/bibliography/rs19.bib"
params:
  j: 19
---
...
bs_carousel(id = 'rs19', use_indicators = TRUE)|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/6054677382_ba0daefc3a_b.jpg'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/5914271720_769f0cef11_b.jpg'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/800px-Adelie_penguin_on_an_iceberg_near_the_Antarctic_Peninsula-1.jpg'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/Screen_Shot_2013-09-13_at_19.03.10.png'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/Screen_Shot_2013-09-13_at_19.07.57.png'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/600px-Antarctica.svg.png'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))|>
bs_append(
    content = bs_carousel_image(
        src = paste0(w, 'img/5917162769_f5dd98c2f5_b.jpg'), alt = 'West Antarctic ice sheet collapse'),
    caption = bs_carousel_caption(title = 'West Antarctic ice sheet collapse'))
...
- Livelihoods and economic activity or Security of housing & infrastructure or Social conflict
...
- Conservation or Tourism or Land use impacts are primarily off-site (e.g. dead zones)
...
``` {style='color: gray;'}
@misc{
  author = {Johanna YletyinenGarry Peterson},
